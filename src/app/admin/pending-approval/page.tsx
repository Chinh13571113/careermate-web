...
export default function PendingApprovalPage() {
  ...
  const handleReject = async (recruiterId: number) => {
    ...
    setSelectedRecruiter(
      recruiters.find((r) => r.recruiterId === recruiterId) || null
    );
    setRejectReason("");
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-sm mt-2">
              All caught up! New recruiter registrations will appear here.
            </p>
          </div>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-6">
            <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
              ...
              <span>
                ...
                pending approval{filteredRecruiters.length !== 1 ? "s" : ""}
              </span>
            </div>
          </div>
        </>
      ...
      <Dialog open={isRejectFormOpen} onOpenChange={setIsRejectFormOpen}>
        <DialogContent className="max-w-2xl rounded-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Please select or provide a reason for rejecting this application.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    key={r}
                    onClick={() => {
                      setSelectedCommonReason(r);
                      if (r !== "Other") setRejectReason(r);
                    }}
                    className={`px-3 py-1 rounded-lg border ${
                      selectedCommonReason === r
