...
export default function ApplicationSuccessPage() {
  ...
  // Set success status when application ID is present
  useEffect(() => {
    if (applicationId) {
      setStatus('success');
    } else {
        ...
        {status === 'error' && (
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8 text-center">
            ...
            <p className="text-gray-600 mb-2">
              Unfortunately, your application could not be processed.
            </p>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-6">
                {availableSkills.map((skill) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full border transition-colors ${selectedSkills.includes(skill)
