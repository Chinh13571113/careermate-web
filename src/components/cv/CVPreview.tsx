...
export default function CVPreview({ templateId = 'minimalist', zoomLevel = 100, cvData = SAMPLE_CV_DATA, onEditClick }: Props) {
  const [zoom, setZoom] = useState(zoomLevel);
  
  const currentTemplate = CV_TEMPLATES.find(t => t.id === templateId) || CV_TEMPLATES[3];
  ...
  return (
    <div className="h-full bg-white flex flex-col">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center justify-between p-4">
          <h2 className="text-lg font-semibold text-gray-800">
            Preview CV - {currentTemplate.name}
          </h2>
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button 
                  ...
                  className={`px-2 py-1 rounded text-xs ${zoom === 100 ? 'bg-blue-100 text-blue-600' : 'hover:bg-gray-100'}`}
                >
                  100%
                </button>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="relative w-24 h-6 flex items-center">
                  ...
                  {/* Input range - ẩn nhưng vẫn hoạt động */}
                  <input
                    type="range"
                    min="50"
                    max="100"
                    ...
                    onInput={(e) => handleZoomChange(Number((e.target as HTMLInputElement).value))}
                  ...
                  <div 
                    className="absolute w-4 h-4 bg-white border-2 border-blue-500 rounded-full shadow-sm transition-all duration-100 hover:scale-110 pointer-events-none"
                    style={{ 
                ...
                <span className="text-xs font-medium min-w-[35px]">{zoom}%</span>
      ...
      <div className="flex-1 overflow-y-auto p-6 bg-gray-50" onWheel={handleWheel}>
        <div 
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  {cvData.skills.map((skillGroup, index) => (
                    <div key={index}>
                      <h3 className="font-medium text-gray-800 mb-2">{skillGroup.category}</h3>
            ...
            <div className="p-8 bg-gradient-to-br from-blue-50 to-white">
              ...
              <div className="grid grid-cols-3 gap-8">
                ...
                <div className="space-y-8">
                  {/* Skills */}
                  <div>
                    <h2 className="text-xl font-bold text-blue-600 mb-4">Kỹ năng</h2>
                    <div className="space-y-4">
                      {cvData.skills.map((skillGroup, index) => (
                  ...
                  {/* Education */}
                  <div>
                    <h2 className="text-xl font-bold text-blue-600 mb-4">Học vấn</h2>
                    <div className="space-y-4">
                      {cvData.education.map((edu, index) => (
                        <div key={index} className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  {/* Languages */}
                  <div>
                    <h2 className="text-xl font-bold text-blue-600 mb-4">Ngôn ngữ</h2>
                    ...
                    <div key={index}>
                      ...
                      {exp.achievements && (
                        <ul className="text-gray-700 ml-4">
                          {exp.achievements.map((achievement, i) => (
                            <li key={i} className="list-disc mb-1">{achievement}</li>
                          ))}
                        </ul>
                      )}
                    </div>
            ...
            <div className="p-8 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
              ...
              <div className="relative bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 text-white p-8 -m-8 mb-8 rounded-br-3xl">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm opacity-90">
                  ...
                  <div className="flex items-center">
                    <span className="mr-2">📍</span> {cvData.personalInfo.location}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-4 space-y-6">
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-lg border-l-4 border-green-500">
                    ...
                    <div className="space-y-4">
                      {cvData.education.map((edu, index) => (
                        <div key={index} className="bg-gradient-to-r from-green-50 to-teal-50 p-4 rounded-lg">
                          <h3 className="font-semibold text-gray-800">{edu.degree}</h3>
                  ...
                  <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="bg-gray-100 p-6 rounded-lg">
                      ...
                      <div className="space-y-3 text-sm text-gray-700">
                        ...
                        <div><strong>Location:</strong> {cvData.personalInfo.location}</div>
                        ...
                        {cvData.skills.map((skillGroup, index) => (
                          <div key={index}>
                            ...
                            <div className="space-y-1">
                              {skillGroup.items.map((skill, i) => (
                                <div key={i} className="text-sm text-gray-700 bg-white px-2 py-1 rounded">
                                  {skill}
                                </div>
                              ))}
                            </div>
